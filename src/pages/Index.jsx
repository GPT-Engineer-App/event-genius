...
import { Box, Heading, Text, Button, Input, Textarea, Stack, Flex, useToast } from "@chakra-ui/react";
  ...
  return (
    <Box maxWidth="600px" margin="auto" padding={4}>
      ...
      <Stack spacing={4} marginBottom={8}>
        ...
        <Button colorScheme="blue" leftIcon={<FaPlus />} onClick={editingEvent ? updateEvent : createEvent}>
      ...
      <Stack spacing={4}>
        {events.map((event) => (
          <Box key={event.id} borderWidth={1} borderRadius="md" padding={4}>
            <Flex justify="space-between" align="center">
              ...
              <Box>
                ...
                <Button colorScheme="red" leftIcon={<FaTrash />} onClick={() => deleteEvent(event.id)}>
                  Delete
                </Button>
              </Box>
            </Flex>
